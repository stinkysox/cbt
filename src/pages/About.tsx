...
const About = () => {
  const metadata = seoConfig.about;
  useSEOHelmet({
    ...metadata,
    breadcrumbs: [{ name: "About", url: metadata.url }],
  });
      ...
      <main className="pt-24">
        ...
        <section className="relative py-24 px-6 overflow-hidden">
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            >
              {siteData.aboutPage.heroTitleLine1}
              <br />
          ...
          <div className="absolute top-[20%] right-[-5%] select-none pointer-events-none opacity-[0.03]">
            <span className="text-[30rem] font-display font-black leading-none">
              {siteData.aboutPage.brandInitials}
            </span>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-4xl md:text-6xl font-display font-bold overflow-visible">
                {siteData.aboutPage.valuesTitleLine1}
                <span className="italic text-gradient inline-block pr-[0.1em] pb-[0.1em] -mb-[0.1em] overflow-visible">
                  {siteData.aboutPage.valuesHighlight}
                </span>
                {siteData.aboutPage.valuesTitleLine2}
              </h2>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {siteData.aboutPage.valuesList.map((value, index) => (
                ...
                >
                  <span className="text-4xl font-display font-black text-accent/20 mb-6 block group-hover:text-accent transition-colors">
                    {value.number}
                  </span>
        ...
        <section className="py-32 px-6 bg-foreground text-primary-foreground text-center relative overflow-hidden">
          <div className="max-w-3xl mx-auto relative z-10">
            ...
            >
              {siteData.aboutPage.ctaTitle}
              <span className="italic opacity-50">
                {siteData.aboutPage.ctaHighlight}
              </span>
              {siteData.aboutPage.ctaPunctuation}
            </motion.h2>
            <motion.div
